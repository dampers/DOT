...
#transparency = driver.find_element_by_css_selector('.transparency .issuance-wrap b').text
    transparency = driver.find_element(By.CSS_SELECTOR, '.transparency .issuance-wrap b').text
#time.sleep(3)
#collateral_value = driver.find_elements_by_css_selector('.tokenList .value')
    collateral_value = driver.find_elements(By.CSS_SELECTOR, '.tokenList .value')
